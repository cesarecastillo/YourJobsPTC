<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="12.index.Interprise.aspx.cs" Inherits="YourJob1._12_index_Interprise" %>
        ...
        function searchAlert() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '02.company.login.aspx';
                }
            })
        }
        |
