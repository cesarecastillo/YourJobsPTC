<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="02.user.login.aspx.cs" Inherits="YourJob1._02_user_login" %>
    ...
    <div class="inner">
        ...
        <form runat="server">
            <asp:Panel runat="server">
                ...
                <asp:HyperLink ID="RegisterLink" runat="server" CssClass="register-link" NavigateUrl="04.user.register.aspx" OnClientClick="return showLinkAlert('04.user.register.aspx')">You don't have an account? Register here</asp:HyperLink>
