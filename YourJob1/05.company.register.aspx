...
<body>
    ...
    <div class="inner">
        ...
        <form runat="server">
            <asp:Panel runat="server">
                ...
                <asp:Button ID="Button1" runat="server" Text="Register" CssClass="animated-button" OnClick="Button1_Click" OnClientClick="return validatePolicy()"  />
    ...
    <div id="privacyPopup" class="popup">
        <div class="popup-content">
            ...
            <h3>7. Contact</h3>
            <p>If you have any questions or concerns about this Privacy Policy, you can contact us at [contact email].</p>

            <p><strong>YourJob</strong><br>
            yourjobs2420@gmail.com</p>
        </div>
    </div>
    <script>
