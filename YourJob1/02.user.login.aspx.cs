...
namespace YourJob1
{
    public partial class _02_user_login : Page
    {
        ...
        protected void RegisterLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                alerta1.Text = "<script>Swal.fire('OOPS', 'No deje espacios en blanco', 'error')</script>";
                return;
            }
            ...
            {
                Session["username"] = email;
                ShowSuccessAlertAndRedirect("12.index.Interprise.aspx");
            }
            else
            {
                alerta1.Text = "<script>Swal.fire('Algo salió mal', 'Su usuario o contraseña no son correctos', 'error')</script>";
                TxtContra1.Text = "";
                TxtUsuario.Text = "";
            }
        }
        ...
        private void SetRegisterLink()
        {
            ...
            RegisterLink.NavigateUrl = "04.user.register.aspx";
        }
    }
}
