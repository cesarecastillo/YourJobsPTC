<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="06.forget.password.aspx.cs" Inherits="YourJob1._06_forget_password" %>

<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>Your Job - Recover Password</title>
        ...
        <form runat="server">
            <asp:Panel runat="server">
                ...
                <div class="form-wrapper">
                    ...
                    <asp:TextBox ID="txtcuenta" runat="server" CssClass="form-control" placeholder="Email Address"></asp:TextBox>
                </div>
                <asp:Button ID="RegisterLogin3" runat="server" Text="Send" CssClass="animated-button" OnClick="RegisterLogin3_Click" />
