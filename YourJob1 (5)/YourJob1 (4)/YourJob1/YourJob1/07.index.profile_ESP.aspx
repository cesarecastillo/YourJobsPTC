<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="07.index.profile_ESP.aspx.cs" Inherits="YourJob1._07_index_profile_ESP" %>
    ...
    <script>
        function logout() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '14.logout.aspx';
                }
            })
        }
    </script>
