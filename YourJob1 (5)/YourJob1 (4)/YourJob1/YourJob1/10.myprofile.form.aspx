...
<body>
    <div class="container">
        ...
        <div class="profile-header">
            <img id="profileImage" src="img/profile-placeholder.png" alt="Profile Photo" runat="server" />
            <div class="profile-info">
                <h2 id="fullName" runat="server">User Name</h2>
                ...
                <a href="editprofile.aspx" class="btn"><i class="fas fa-edit"></i> Edit Profile</a>
            </div>
        </div>
        <div class="profile-content">
            <div class="profile-section">
                <h3><i class="fas fa-user"></i> Personal Information</h3>
                <p id="email" runat="server">email@example.com</p>
                <p id="age" runat="server">Age: 25</p>
                <p id="gender" runat="server">Gender: Male</p>
                <p id="nationality" runat="server">Nationality: El Salvador</p>
                <p id="civilStatus" runat="server">Civil Status: Single</p>
                <p id="phone" runat="server">Phone: 12345678</p>
                <p id="errorMessage" runat="server" style="color: red;"></p> <!-- Container for error messages -->
            </div>
            <!-- Commented out for now
            <div class="profile-section">
                <h3><i class="fas fa-user"></i> Personal Biography</h3>
                <p id="biography" runat="server">A brief biography of the user.</p>
            </div>
            -->
            <div class="profile-section">
                <h3><i class="fas fa-user-graduate"></i> Education</h3>
                <ul id="educationDetails" runat="server">
                    <li>Example University - Systems Engineering</li>
                </ul>
            </div>
            <div class="profile-section">
                <h3><i class="fas fa-briefcase"></i> Work Experience</h3>
                <ul id="workExperienceDetails" runat="server">
                    <li>Software Developer at Example Company (2015-2020)</li>
                </ul>
            </div>
            <div class="profile-section">
            ...
            <div class="profile-section">
                <h3><i class="fas fa-language"></i> Mastered Languages</h3>
                <p id="masteredLanguages" runat="server">Spanish, English</p>
            </div>
        </div>
    </div>
    <script>
