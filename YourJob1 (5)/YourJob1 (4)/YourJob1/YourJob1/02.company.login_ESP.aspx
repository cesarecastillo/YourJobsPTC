<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="02.company.login_ESP.aspx.cs" Inherits="YourJob1._02_company_login_ESP" %>
...
<body>
    ...
    <div class="inner">
        ...
        <form runat="server">
            <asp:Panel runat="server">
                ...
                <asp:HyperLink ID="RegisterLink" runat="server" CssClass="register-link" NavigateUrl="05.company.register.aspx" OnClientClick="return showLinkAlert('05.company.register.aspx')">¿No tienes una cuenta? Regístrate aquí</asp:HyperLink>
    ...
    <script>
        ...
        function showPolicy() {
            Swal.fire({
                title: 'Políticas de Your Jobs',
                text: 'Aquí están las políticas de Your Jobs...',
                icon: 'info',
