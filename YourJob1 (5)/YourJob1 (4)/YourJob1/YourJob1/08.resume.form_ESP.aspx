<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="08.resume.form_ESP.aspx.cs" Inherits="YourJob1._08_resume_form_ESP" %>
...
<head>
    ...
    <script>
        ...
        function validarFormulario() {
            ...
            var idiomas = document.getElementById("txtidiomas").value;
            var imagen = document.getElementById("txtimagen").value;

            if (telefono == "" || experiencia == "" || educacion == "" || campoEstudio == "" || sector == "" || habilidades == "" || idiomas == "" || imagen == "") {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
        ...
        <form runat="server" onsubmit="return validarFormulario()">
            <div id="tabs" class="tabs">
                <ul>
                    ...
                    <li><a href="#tabs-5">Idiomas</a></li>
                    <li><a href="#tabs-6">Imagen</a></li>
                </ul>
                <div id="tabs-1">
                ...
                <div id="tabs-5">
                    <div class="form-wrapper">
                        ...
                        <asp:TextBox ID="txtidiomas" runat="server" TextMode="MultiLine" Rows="4" placeholder="Idiomas" CssClass="form-control" Required="True"></asp:TextBox>
                    </div>
                </div>
                <div id="tabs-6">
                    <div class="form-wrapper">
